...
export const Navigation = () => {
  ...
  const [isCollapsed, setIsCollapsed] = useState(isModile);
  ...
  const resetWidth = () => {
    if(sidebarRef.current && navbarRef.current) {
      ...
      sidebarRef.current.style.width = isModile ? "100%" : "240px";
      navbarRef.current.style.setProperty(
        "width",
        isModile ? "0" : "calc(100% - 240px)"
      );
      navbarRef.current.style.setProperty(
        "left",
        isModile ? "100%" : "240px"
